...
echo "=========================================="
echo "YouTube Downloader V0.6.1 - macOS $ARCH_LABEL"
echo "=========================================="
echo ""
...
ZIP_PATH="macos_output/YouTubeDownloader-macOS-$ARCH_LABEL-v0.6.1.zip"
DMG_PATH="macos_output/YouTubeDownloader-macOS-$ARCH_LABEL-v0.6.1.dmg"
